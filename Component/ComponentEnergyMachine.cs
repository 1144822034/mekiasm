...
namespace Mekiasm
{
	public abstract class ComponentEnergyMachine : Component, IInventory
	{
		public int mode = 0;
		...
		public StreamingSound streamingSound;
		public Dictionary<Point3, int> connections;
		public SubsystemViews subsystemViews;
		public string err;
		...
		{
			base.Dispose();
			if(streamingSound!=null)streamingSound.Dispose();
		}
		public  void playSound(string soundName,Vector3 position) {
			...
			if (f >= 10) f = 0; else f = 1f - f / 10;
			if (streamingSound.State == SoundState.Disposed || streamingSound.State == SoundState.Paused || streamingSound.State == SoundState.Stopped) streamingSound.Play();
			streamingSound.Volume = f;
		}
		public void pauseSound() {
			if (streamingSound != null) if (streamingSound.State == SoundState.Playing) streamingSound.Pause();
		}
