...
{
    //粉碎机
    public class ComponentCrusher : ComponentEnergyMachine, IUpdateable
    {
        ...
        public string musicname = "Mekiasm/sounds/crusher";
        public bool flag = false;
        public int thisID = Terrain.MakeBlockValue(1003, 0, 47);
