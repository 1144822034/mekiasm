...
{
    //充能冶炼炉
    public class ComponentSmelt : ComponentEnergyMachine, IUpdateable
    {
        ...
        public string musicname = "Mekiasm/sounds/smelter";
        public bool flag = false;
        public int thisID = Terrain.MakeBlockValue(1003, 0, 72);
